                    ...
                    <div class="flat-iconbox clearfix">
                        <div class="item-three-column">
                            <div class="iconbox">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <strong>Online Sales:</strong> 1 800 232 3485<br>
                        ...
                        <div class="item-three-column">
                            <div class="iconbox">
                                ...
                                <div class="box-content">
                                    <p>Headquarters (New York Office)</p>
                                    <p>
                                        <strong>Street:</strong> 66 Nicholson Street.<br>
                                        <strong>City:</strong> Buffalo New York 1412.<br>
